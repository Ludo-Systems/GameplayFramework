...
namespace CoreGameplayTags
{
	...
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Input_PickupMoveItem);
	...
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_Layer);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_Layer_Game);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_Layer_GameMenu);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_Layer_Menu);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_Layer_Modal);
	...
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Action_Look);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Action_PickupMoveitem);
	...
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Level);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Level_ID);
	DA_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Level_POI);
