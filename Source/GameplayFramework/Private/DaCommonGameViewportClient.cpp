...
#include "DaCommonGameViewportClient.h"
...
UDaCommonGameViewportClient::UDaCommonGameViewportClient()
{
}

void UDaCommonGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance,
